    ...
    <section id="products" className="section products-section">
      <div className="container">
        ...
        <div className="products-content">
          <div className="product-item animate-on-scroll animate-delay-1" ref={addMouseRef}>
            <h3>ZAICO</h3>
          ...
          <div className="product-item animate-on-scroll animate-delay-2" ref={addMouseRef}>
            <h3>Overlander</h3>
