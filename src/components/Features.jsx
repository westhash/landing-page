    ...
    <section id="features" className="section features-section">
      <div className="container">
        ...
        <div className="features-grid">
          <div className="feature-card reveal" data-rd="0">
          ...
          <div className="feature-card reveal" data-rd="60">
            <div className="feature-icon">
          ...
          <div className="feature-card reveal" data-rd="120">
            <div className="feature-icon">
          ...
          <div className="feature-card reveal" data-rd="180">
            <div className="feature-icon">
